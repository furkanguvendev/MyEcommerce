        ...
        <div className="flex flex-col flex-grow basis-0 gap-10 text-left items-center justify-center">
            <div className="flex flex-col justify-center gap-10">
                ...
                <div className="flex flex-col w-full xl:flex-row gap-3 max-xl:items-center">
                    <button disabled={true} className="w-48 h-16 rounded-lg font-bold text-white bg-sky-500 xl:bg-green-500">BUY NOW</button>
                    <button disabled={true} className="w-52 h-16 rounded-lg font-bold text-sky-500 xl:text-green-500 border-2 border-sky-500 xl:border-green-500">READ MORE</button>
                </div>
            </div>
