...
export const FluidSection = () => {
  return (
    <div className="flex flex-row xl:w-4/5 items-center">
        <img src={Picture} alt='' className='flex-grow basis-0 object-cover max-xl:hidden max-w-[50%]'/>
        <div className="flex flex-col flex-grow basis-0 gap-10 text-left items-center justify-center">
            <div className="flex flex-col justify-center gap-10">
                ...
                <div className="flex flex-col w-full xl:flex-row gap-3 max-xl:items-center">
                    <Link to={"/shop/k/elbise/4"} className="flex items-center justify-center w-48 h-16 rounded-lg font-bold text-white bg-sky-500 xl:bg-green-500">BUY NOW</Link>
                    <Link to={"/aboutus"} className="flex items-center justify-center w-52 h-16 rounded-lg font-bold text-sky-500 xl:text-green-500 border-2 border-sky-500 xl:border-green-500">READ MORE</Link>
                </div>
            </div>
