...
export const Clients = () => {
  return (
    <div className="w-full bg-zinc-50 py-28 flex justify-center">
        <div className="w-4/5 flex flex-col gap-12 items-center">
            <h3 className="text-40 xl:text-[53.3px] text-slate-800 font-bold">Big Companies Are Here</h3>
            <p className="text-sm xl:text-lg text-neutral-500 font-normal xl:text-center">Problems trying to resolve the conflict <br className="xl:hidden"/>between <br className="max-xl:hidden"/>the two major realms of Classical <br className="xl:hidden"/>physics: Newtonian mechanics</p>
